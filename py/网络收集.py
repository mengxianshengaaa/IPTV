...
# 定义一个包含所有要提取的关键词的列表
extract_keywords = [
       'CCTV1,', 'CCTV3', 'CCTV6', 'CCTV8', 'CCTV15', 'CCTV12', '家庭影院', '高清电影', '剧场', '动作电影', '湖北卫视', '湖南卫视', '江苏卫视', '辽宁卫视', '安徽卫视', '东方卫视', '广东卫视', '凤凰卫视', \
       '人间卫视', '亚洲卫视', '香港卫视', '神乐', '翡翠台', '凤凰香港', '凤凰中文', '凤凰资讯', 'AXN', 'AMC', '香蕉', '电影台', '大爱', '东森', \
