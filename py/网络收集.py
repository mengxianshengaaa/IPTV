...
# 定义一个包含所有要排除的关键词的列表
excluded_keywords = [
    'epg', 'mitv', 'udp', 'rtp', 'P2p', 'p2p', 'p3p', 'P2P', '新闻综合', 'P3p', 'qilu', 'shandong', 'goodiptv', '购物', '[', 'P3P', '腔', '曲', '/tsfile/#', '/hls/#', '春节'
    # 在这里添加需要排除的关键词
]

# 定义一个包含所有要提取的关键词的列表
extract_keywords = ['fangke', '1905', '凤凰卫视', '人间卫视', '亚洲卫视', '香港卫视', '神乐', '翡翠台', '凤凰香港', '凤凰中文', '凤凰资讯', 'AXN', 'AMC', '香蕉', '电影台', '大爱', '东森', 'MTV', 
