...
# 定义一个包含所有要排除的关键词的列表
excluded_keywords = [
    'epg', 'mitv', 'udp', 'rtp', 'P2p', 'p2p', 'p3p', 'P2P', '新闻综合', 'P3p', 'goodiptv', '购物', '[', 'P3P', '腔', '曲', '/zy#.', '/xgj#.', '春节'
]

# 定义一个包含所有要提取的关键词的列表
extract_keywords = [
       '星空卫视', '凤凰卫视', '人间卫视', '亚洲卫视', '香港卫视', '神乐', '翡翠台', '凤凰香港', '凤凰中文', '凤凰资讯', 'AXN', 'AMC', '香蕉', '电影台', '大爱', '东森', \
       '中天', '天良', '翡翠台', '美亚', '星影台', '纬来', '天映', '无线功夫', '华剧台', '华丽台', '剧台', 'Movie', '八大', '采昌', \
       '靖天', '美亚', '民視', '中视', '豬哥亮', 'TVB', '东森', '公视', '华视', '寰宇', '戏剧', '靖', '龙华', '龙祥', '民视', '三立', '中视', '猪哥亮', \
       '探索', '旅游', '影视2', '影视3', 'MTV', '华视', '综艺', '新闻'
    # 在这里添加需要提取的关键词
]
