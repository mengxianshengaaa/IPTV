...
# 定义一个包含所有要提取的关键词的列表
extract_keywords = [
    'CCTV', '卫视', '动作电影', '风云剧场', '怀旧剧场', '影迷电影', '高清电影', '动作电影', '全球大片', '第一剧场', 'TVB', '家庭影院', '神乐电影', \
       '星光影院', '华语电影', '美国大片', '峨眉电影', '凤凰中文', '凤凰卫视', '凤凰资讯', '百变课堂', '宝宝动画', '茶', '超级体育', '电竞天堂', \
       '谍战剧场', '东方财经', '东方影视', '动漫秀场', '都市剧场', '法治天地', '哈哈炫动', '华语影院', '欢笑剧场', '纪实科教', '健康养生', \
       '劲爆体育', '金色学堂', '金鹰纪实', '卡酷少儿', '看天下精选', '快乐垂钓', '魅力足球', '七彩戏剧', '青春动漫', '全纪实', '全球大片', '热门剧场', \
       '热门综艺', '上海第一财经', '上海都市', '上海纪实', '上海教育', '上视外语', '上视新闻', '生活时尚', '陶瓷', '五星体育', '新视觉', '游戏风云', \
       '中国教育', '翡翠台', '凤凰香港', '凤凰中文', '凤凰资讯', '广东少儿', '广东体育', '广东影视', '广东珠江', '广东综艺', '金鹰卡通', '优漫卡通', \
       '纯享', '第一财经', '都市', '国际', '欢笑剧场4K', '纪实人文', 'GATV電影台', '不挤影院', '大愛', '東森', '鳳凰資訊', '公視', \
       '華藏衛視', '華視', '欢笑影院', '中視', '中天', '鳳凰衛視', '寰宇', '民視戲劇館', 'Thrill电影台', '凤凰香港台', '黄金翡翠台', \
       '黄金华剧台', '美亚电影台', 'now星影台', 'popc电影台', '天映', '无线翡翠台', '无线功夫台', '无线华剧台', '无线华丽台', '无线新闻台', \
       '无线亚剧台', '電影台', '八大', '采昌', '靖天', '龍華', '民視', '中視', '豬哥亮', 'TVB', '东森', '公视', '华视', '寰宇', '靖天', '龙华', \
       '民视', '三立', '中视', '猪哥亮', '河北公共', '河北经济', '河北农民', '河北少儿', '河北影视', '浙江国际', '浙江教科', '浙江经济', \
       '浙江民生', '浙江少儿', '浙江新闻'
    # 在这里添加需要提取的关键词
]
