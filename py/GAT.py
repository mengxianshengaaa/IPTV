...
keywords = ['凤凰卫视', '人间卫视', '亚洲卫视', '香港卫视', '动作电影', '翡翠台', '凤凰香港', '凤凰中文', '凤凰资讯', 'AXN', 'AMC电影', '电影台', '大爱', '东森', 'MTV', '好莱坞', 
            '华视', '中天', '天良', '美亚', '星影', '纬来', '天映', '无线', '华剧台', '华丽台', '剧台', 'Movie', '八大', '采昌', '靖天', '民视', '探索', '影视2', 
            '影视3', '中视', '豬哥亮', 'TVB', '公视', '寰宇', '戏剧', '靖', '龙华', '龙祥', '猪哥亮', '综艺', '影迷', '影剧', '电视剧', '49号', '台视', '华视', '影院', 
            '中华小当家', '中天娱乐', '公视戏剧', '动漫', '动物星球', '动画台', '高清电影', '壹新闻', '大立电视', '天良综合台', '影迷电影', '探案', '家庭影院', '剧场', '超人', '番薯']  # 这里定义你的搜索关键词列表
output_file = 'gat.txt'
